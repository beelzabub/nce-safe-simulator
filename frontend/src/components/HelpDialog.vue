...
const REPORTS = [
  ...
  { key: 'epic-lifecycle',        label: 'Epic Lifecycle',             description: 'Lifecycle stage distribution across the portfolio — how many epics are in funnel, backlog, implementing, and done at each level. Also flags "stuck" items: epics in lifecycle::funnel > 90 days, lifecycle::analyzing > 30 days, or lifecycle::backlog > 60 days (age measured from created_at).' },
