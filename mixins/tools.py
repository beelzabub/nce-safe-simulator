...
TOOLS = [
    ...
    },
    {
        ...
        "params": [
            ...
            {"name": "on_existing",        "prompt": "If an epic with the same title exists (create / skip / update)",          "type": str,  "widget": "select", "options": ["create", "skip", "update"], "default": "create"},
    ...
    },
    {
        ...
        "params": [
            ...
            {"name": "on_existing",         "prompt": "If an issue with the same title exists (create / skip / update)",  "type": str,  "widget": "select", "options": ["create", "skip", "update"], "default": "create"},
            {"name": "dry_run",             "prompt": "Preview (dry run) — validate and preview only, nothing is created", "type": bool, "default": False, "cli_only": True},
        ],
    },
    {
