...
TOOLS = [
    ...
    },
    {
        ...
        "params": [
            ...
            {"name": "dest_group",         "prompt": "Destination group for the imported epics (blank = use each row's group_path, else target root)", "type": str,  "widget": "group-picker", "optional": True},
    ...
    },
    {
        ...
        "params": [
            ...
            {"name": "group",               "prompt": "Target group (import into)",                                 "type": str,  "widget": "group", "optional": True},
            {"name": "create_missing",      "prompt": "Create target group if it doesn't exist",                    "type": bool, "default": False},
            {"name": "target_project_path", "prompt": "Target project path (blank = use project_path column)",      "type": str,  "widget": "project", "optional": True},
            {"name": "dry_run",             "prompt": "Preview (dry run) — validate and preview only, nothing is created", "type": bool, "default": False, "cli_only": True},
        ],
    },
    {
